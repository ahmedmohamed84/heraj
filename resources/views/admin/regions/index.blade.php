            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold">قائمة المناطق</h3>
                        <a href="{{ route('admin.regions.create') }}" class="px-4 py-2 bg-green-500 text-black rounded-md hover:bg-green-600">إضافة منطقة جديدة</a>
                    </div>
